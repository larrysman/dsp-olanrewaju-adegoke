...
def dataframe_equality_check_test_data(test_set: pd.DataFrame) -> None:
...
def resetting_index_of_dataframe(final_test_csv: pd.DataFrame, final_test_csv_df: pd.DataFrame) -> Tuple[pd.DataFrame, pd.DataFrame]:
...
def save_and_load_parquet_test_csv(test_set: pd.DataFrame) -> Tuple[pd.DataFrame, pd.DataFrame]:
...
def preprocessing_test_data(categorical_features: List[str], continuous_features: List[str], test_csv_features: pd.DataFrame) -> pd.DataFrame:
...
def scaling_continuous_features_test_data(continuous_features: List[str], test_csv_features: pd.DataFrame) -> pd.DataFrame:
...
def encoding_categorical_features_test_data(categorical_features: List[str], test_csv_features: pd.DataFrame) -> pd.DataFrame:
...
def check_and_correct_NaN(test_csv_features: pd.DataFrame) -> None:
